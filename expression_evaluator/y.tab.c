...
{
       8,    12,    -2,     4,    -2,   -11,   -11,   -11,    -2,    -2,
      -1,     6,    11,   -11,    17,    -2,    20,   -11,   -10,   -11,
      -2,    -2,    -2,    -2,    -2,   -11,    21,   -11,   -11,   -11,
     -11,   -11,   -11,    22,   -11,   -11
};
...
{
       0,     0,     0,     0,     0,     6,    16,    17,     0,     0,
       0,    10,    13,     1,     0,     0,     0,    15,     0,     3,
       0,     0,     0,     0,     0,     7,     0,     2,    14,     8,
       9,    11,    12,     0,     5,     4
};
...
{
      16,     6,     7,    28,    13,    18,    19,     8,    14,    15,
       9,    26,     1,     2,    20,    21,    29,    30,     4,     5,
      33,    22,    23,    24,    25,    31,    32,    27,    34,    35,
       0,    17
};

static const yytype_int8 yycheck[] =
{
       4,     3,     4,    13,     0,     9,     7,     9,     4,     5,
      12,    15,     4,     5,     8,     9,    20,    21,     6,     7,
      24,    10,    11,     6,     7,    22,    23,     7,     7,     7,
      -1,     8
};
...
{
       0,     4,     5,    15,     6,     7,     3,     4,     9,    12,
      16,    17,    18,     0,     4,     5,    16,    18,    16,     7,
       8,     9,    10,    11,     6,     7,    16,     7,    13,    16,
      16,    17,    17,    16,     7,     7
};
...
#line 23 "exp.y" /* yacc.c:1646  */
    { printf("Printing %s = %f\n", (yyvsp[-3].id), (yyvsp[-1].f)); store_identifier((yyvsp[-3].id), (yyvsp[-1].f)); }
...
#line 27 "exp.y" /* yacc.c:1646  */
    { printf("%s = %f\n", (yyvsp[-1].id), get_identifier_value((yyvsp[-1].id))); }
...
#line 44 "exp.y" /* yacc.c:1646  */
    { (yyval.f) = get_identifier_value((yyvsp[0].id)); }
